 ...
 
{
    ...
    folders: ['smart railway admin'],
    shortDesc: 'A robust web-based railway management and ticketing system featuring secure admin authentication, dynamic route loading, and multi-class booking workflows.',
    longDesc: 'Smart Railway was developed as an institutional presentation project (Web Development subject) to solve ticketing and scheduling bottlenecks in Sri Lankan railway operations. Built using Java Servlets, Hibernate ORM, and Gson for backend processing, paired with an interactive HTML, CSS, and JavaScript frontend, the platform provides secure session management, asynchronous JSON data handling, and comprehensive admin controls for trains, routes, and multi-class seat reservations.',
    features: [
      'Robust backend architecture developed using Java Servlets, Hibernate ORM, and Criteria API for secure and efficient database operations.',
      'Asynchronous JSON communication implemented via Google Gson for seamless data transfer between the backend and frontend.',
      'Secure Administrator Authentication and verification system featuring email-based OTP/code dispatch using multi-threading.',
      'Dynamic Route and Train Loading system (LoadRouteHome Servlet) to filter and synchronize active trains and schedules in real-time.',
      'Multi-class seat booking and configuration supporting First Class, Second Class, and Third Class accommodations.',
      'Centralized Admin Panel to manage train inventories, routes, seat allocations, and oversee passenger booking sessions securely.',
    ],
    vision: 'Designed to modernize public transit operations by resolving ticketing constraints, offering seamless seat reservations, and delivering a secure, high-performance administrative dashboard for railway management.',
    tech: ['Java', 'Hibernate', 'Servlets', 'HTML', 'CSS', 'JavaScript', 'MySQL'],
    liveLink: '',
    githubLink: '',
  },
...

{
    ...
    title: 'Smart Railway User Platform',
    folders: ['smart railway user'],
    shortDesc: 'A passenger-centric web application enabling users to check train timetables, view specific route schedules, and book tickets online.',
    longDesc: 'The Smart Railway User Platform was developed alongside the admin panel to give everyday commuters a seamless digital travel experience. Built using Java Servlets, Hibernate ORM, and Gson on the backend with an interactive HTML, CSS, and JavaScript frontend, the platform allows users to browse real-time train timetables, look up specific routes, select multi-class seat categories (First, Second, and Third Class), complete online ticket bookings, and generate digital tickets.',
    features: [
      'Interactive passenger interface built with HTML, CSS, and JavaScript for seamless navigation and timetable lookups.',
      'Robust backend architecture powered by Java Servlets and Hibernate ORM for efficient data retrieval and transaction handling.',
      'Real-time train timetable and route tracking system to view active train schedules and operating hours.',
      'Multi-class seat selection supporting First Class, Second Class, and Third Class ticket reservations.',
      'Online ticket booking workflow allowing passengers to reserve seats and secure their journey digitally.',
      'Digital ticket generation and online payment integration capabilities for a complete end-to-end e-ticketing experience.',
    ],
    vision: 'Designed to eliminate long queues and booking complexities by offering commuters a direct, user-friendly digital platform for checking train schedules and securing tickets online.',
    tech: ['Java', 'Hibernate', 'Servlets', 'HTML', 'CSS', 'JavaScript', 'MySQL'],
    liveLink: '',
    githubLink: '',
  },

   {
    ...
    folders: ['smartretail user'], // src/assets/project/smartretail/ folder එකේ images
